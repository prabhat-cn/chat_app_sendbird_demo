...
class ChatScreenOld2 extends StatefulWidget {
  final String userId;
  final String appId;

  const ChatScreenOld2({super.key, required this.userId, required this.appId});

  @override
  _ChatScreenOld2State createState() => _ChatScreenOld2State();
}

class _ChatScreenOld2State extends State<ChatScreenOld2> {
